...
function AddBranch({
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      setShowLoader(true);
      Axios.post(process.env.REACT_APP_BACKEND_URL + "/facility/createBranch", {
        token,
        name,
        latitude,
        longitude,
    ...
    <div>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Register New Branch</Modal.Title>
        </Modal.Header>
            ...
            <div className="form-group my-2">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  setMainName(
                    users.filter((item) => item.managerId === e.target.value)[0]
                      ?.name
                  );
                }}
              >
                ...
                {users.map((user, i) => (
                  <option key={i} value={user.managerId}>
                    {user.name}
                  </option>
                ))}
              </select>
